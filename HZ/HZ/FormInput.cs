...
namespace HZ
{
    public partial class FormInput : Form
    {
        ...
        public FormBidPhoto.data addData = new FormBidPhoto.data();
        private Graphics g;
        private void FormInput_Load(object sender, EventArgs e)
        {
            if (type == (int)ENUM.type.NEW)
            {
        ...
        {
            FormBidPhoto.data Data = new FormBidPhoto.data();
            ...
            FormBidPhoto formBidPhoto = (FormBidPhoto)this.Owner;
            switch (type)
            {
                case (int)ENUM.type.NEW:
                    {
                        formBidPhoto.addList(Data);
                        break;
                    }
                case (int)ENUM.type.EDIT:
                    {
                        formBidPhoto.editList(Data, index);
                        break;
                    }
                case (int)ENUM.type.INSERT:
                    {
                        formBidPhoto.insertList(Data, index);
                        break;
                    }
            }
